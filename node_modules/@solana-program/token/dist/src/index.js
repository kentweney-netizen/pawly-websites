...
function getMintEncoder() {
  return kit.getStructEncoder([
    ["mintAuthority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: kit.getU32Encoder(), noneValue: "zeroes" })],
    ["supply", kit.getU64Encoder()],
    ["decimals", kit.getU8Encoder()],
    ["isInitialized", kit.getBooleanEncoder()],
    ["freezeAuthority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: kit.getU32Encoder(), noneValue: "zeroes" })]
  ]);
}
function getMintDecoder() {
  return kit.getStructDecoder([
    ["mintAuthority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: kit.getU32Decoder(), noneValue: "zeroes" })],
    ["supply", kit.getU64Decoder()],
    ["decimals", kit.getU8Decoder()],
    ["isInitialized", kit.getBooleanDecoder()],
    ["freezeAuthority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: kit.getU32Decoder(), noneValue: "zeroes" })]
  ]);
}
...
function decodeMint(encodedAccount) {
  return kit.decodeAccount(encodedAccount, getMintDecoder());
}
...
function decodeMultisig(encodedAccount) {
  return kit.decodeAccount(encodedAccount, getMultisigDecoder());
}
...
function getTokenEncoder() {
  return kit.getStructEncoder([
    ...
    ["delegate", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: kit.getU32Encoder(), noneValue: "zeroes" })],
    ["state", getAccountStateEncoder()],
    ["isNative", kit.getOptionEncoder(kit.getU64Encoder(), { prefix: kit.getU32Encoder(), noneValue: "zeroes" })],
    ["delegatedAmount", kit.getU64Encoder()],
    ["closeAuthority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: kit.getU32Encoder(), noneValue: "zeroes" })]
  ]);
}
function getTokenDecoder() {
  return kit.getStructDecoder([
    ...
    ["delegate", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: kit.getU32Decoder(), noneValue: "zeroes" })],
    ["state", getAccountStateDecoder()],
    ["isNative", kit.getOptionDecoder(kit.getU64Decoder(), { prefix: kit.getU32Decoder(), noneValue: "zeroes" })],
    ["delegatedAmount", kit.getU64Decoder()],
    ["closeAuthority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: kit.getU32Decoder(), noneValue: "zeroes" })]
  ]);
}
...
function decodeToken(encodedAccount) {
  return kit.decodeAccount(encodedAccount, getTokenDecoder());
}
...
function getAmountToUiAmountInstructionDataCodec() {
  return kit.combineCodec(getAmountToUiAmountInstructionDataEncoder(), getAmountToUiAmountInstructionDataDecoder());
}
...
function parseAmountToUiAmountInstruction(instruction) {
  if (instruction.accounts.length < 1) {
    throw new kit.SolanaError(kit.SOLANA_ERROR__PROGRAM_CLIENTS__INSUFFICIENT_ACCOUNT_METAS, {
...
function getApproveInstructionDataCodec() {
  return kit.combineCodec(getApproveInstructionDataEncoder(), getApproveInstructionDataDecoder());
}
...
function getApproveCheckedInstructionDataCodec() {
  return kit.combineCodec(getApproveCheckedInstructionDataEncoder(), getApproveCheckedInstructionDataDecoder());
}
...
var BATCH_DISCRIMINATOR = 255;
function getBatchDiscriminatorBytes() {
  return kit.getU8Encoder().encode(BATCH_DISCRIMINATOR);
}
function getBatchInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU8Encoder()],
      [
        ...
        kit.getArrayEncoder(
          kit.getStructEncoder([
            ["numberOfAccounts", kit.getU8Encoder()],
            ["instructionData", kit.addEncoderSizePrefix(kit.getBytesEncoder(), kit.getU8Encoder())]
          ]),
          { size: "remainder" }
        )
      ]
...
function getBatchInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU8Decoder()],
    [
      "data",
      kit.getArrayDecoder(
        kit.getStructDecoder([
          ["numberOfAccounts", kit.getU8Decoder()],
          ["instructionData", kit.addDecoderSizePrefix(kit.getBytesDecoder(), kit.getU8Decoder())]
        ]),
        { size: "remainder" }
      )
    ]
...
function getBatchInstructionDataCodec() {
  return kit.combineCodec(getBatchInstructionDataEncoder(), getBatchInstructionDataDecoder());
}
function getBatchInstruction(input, config) {
  const programAddress = config?.programAddress ?? TOKEN_PROGRAM_ADDRESS;
  const args = { ...input };
  return Object.freeze({
    data: getBatchInstructionDataEncoder().encode(args),
    programAddress
  });
}
function parseBatchInstruction(instruction) {
  return {
    programAddress: instruction.programAddress,
...
function getBurnInstructionDataCodec() {
  return kit.combineCodec(getBurnInstructionDataEncoder(), getBurnInstructionDataDecoder());
}
...
function getBurnCheckedInstructionDataCodec() {
  return kit.combineCodec(getBurnCheckedInstructionDataEncoder(), getBurnCheckedInstructionDataDecoder());
}
...
function getCloseAccountInstructionDataCodec() {
  return kit.combineCodec(getCloseAccountInstructionDataEncoder(), getCloseAccountInstructionDataDecoder());
}
...
async function getCreateAssociatedTokenInstructionAsync(input, config) {
  ...
  if (!accounts.ata.value) {
    accounts.ata.value = await findAssociatedTokenPda({
      owner: programClientCore.getAddressFromResolvedInstructionAccount("owner", accounts.owner.value),
      tokenProgram: programClientCore.getAddressFromResolvedInstructionAccount("tokenProgram", accounts.tokenProgram.value),
      mint: programClientCore.getAddressFromResolvedInstructionAccount("mint", accounts.mint.value)
    });
  }
...
function getCreateAssociatedTokenIdempotentDiscriminatorBytes() {
  return kit.getU8Encoder().encode(CREATE_ASSOCIATED_TOKEN_IDEMPOTENT_DISCRIMINATOR);
}
...
function getFreezeAccountInstructionDataCodec() {
  return kit.combineCodec(getFreezeAccountInstructionDataEncoder(), getFreezeAccountInstructionDataDecoder());
}
...
function getGetAccountDataSizeInstructionDataCodec() {
  return kit.combineCodec(getGetAccountDataSizeInstructionDataEncoder(), getGetAccountDataSizeInstructionDataDecoder());
}
...
function getInitializeAccountInstructionDataCodec() {
  return kit.combineCodec(getInitializeAccountInstructionDataEncoder(), getInitializeAccountInstructionDataDecoder());
}
...
function getInitializeAccount2InstructionDataCodec() {
  return kit.combineCodec(getInitializeAccount2InstructionDataEncoder(), getInitializeAccount2InstructionDataDecoder());
}
...
function getInitializeMintInstructionDataCodec() {
  return kit.combineCodec(getInitializeMintInstructionDataEncoder(), getInitializeMintInstructionDataDecoder());
}
...
function getInitializeMint2InstructionDataCodec() {
  return kit.combineCodec(getInitializeMint2InstructionDataEncoder(), getInitializeMint2InstructionDataDecoder());
}
...
function getInitializeMultisigInstructionDataCodec() {
  return kit.combineCodec(getInitializeMultisigInstructionDataEncoder(), getInitializeMultisigInstructionDataDecoder());
}
function getInitializeMultisigInstruction(input, config) {
  ...
  const remainingAccounts = args.signers.map((address) => ({ address, role: kit.AccountRole.READONLY }));
  const getAccountMeta = programClientCore.getAccountMetaFactory(programAddress, "programId");
  return Object.freeze({
    accounts: [
...
function getInitializeMultisig2InstructionDataCodec() {
  return kit.combineCodec(getInitializeMultisig2InstructionDataEncoder(), getInitializeMultisig2InstructionDataDecoder());
}
...
function getMintToInstructionDataCodec() {
  return kit.combineCodec(getMintToInstructionDataEncoder(), getMintToInstructionDataDecoder());
}
...
function getMintToCheckedInstructionDataCodec() {
  return kit.combineCodec(getMintToCheckedInstructionDataEncoder(), getMintToCheckedInstructionDataDecoder());
}
...
async function getRecoverNestedAssociatedTokenInstructionAsync(input, config) {
  ...
  if (!accounts.ownerAssociatedAccountAddress.value) {
    accounts.ownerAssociatedAccountAddress.value = await findAssociatedTokenPda({
      owner: programClientCore.getAddressFromResolvedInstructionAccount("walletAddress", accounts.walletAddress.value),
      tokenProgram: programClientCore.getAddressFromResolvedInstructionAccount("tokenProgram", accounts.tokenProgram.value),
      mint: programClientCore.getAddressFromResolvedInstructionAccount(
  ...
  if (!accounts.nestedAssociatedAccountAddress.value) {
    accounts.nestedAssociatedAccountAddress.value = await findAssociatedTokenPda({
      owner: programClientCore.getAddressFromResolvedInstructionAccount(
...
function getRevokeInstructionDataCodec() {
  return kit.combineCodec(getRevokeInstructionDataEncoder(), getRevokeInstructionDataDecoder());
}
...
function getSetAuthorityInstructionDataCodec() {
  return kit.combineCodec(getSetAuthorityInstructionDataEncoder(), getSetAuthorityInstructionDataDecoder());
}
...
function getSyncNativeInstructionDataCodec() {
  return kit.combineCodec(getSyncNativeInstructionDataEncoder(), getSyncNativeInstructionDataDecoder());
}
function getSyncNativeInstruction(input, config) {
  ...
  const getAccountMeta = programClientCore.getAccountMetaFactory(programAddress, "omitted");
  return Object.freeze({
...
function getThawAccountInstructionDataCodec() {
  return kit.combineCodec(getThawAccountInstructionDataEncoder(), getThawAccountInstructionDataDecoder());
}
...
function getTransferInstructionDataCodec() {
  return kit.combineCodec(getTransferInstructionDataEncoder(), getTransferInstructionDataDecoder());
}
...
function getTransferCheckedInstructionDataCodec() {
  return kit.combineCodec(getTransferCheckedInstructionDataEncoder(), getTransferCheckedInstructionDataDecoder());
}
...
function getUiAmountToAmountInstructionDataCodec() {
  return kit.combineCodec(getUiAmountToAmountInstructionDataEncoder(), getUiAmountToAmountInstructionDataDecoder());
}
...
var UNWRAP_LAMPORTS_DISCRIMINATOR = 45;
function getUnwrapLamportsDiscriminatorBytes() {
  return kit.getU8Encoder().encode(UNWRAP_LAMPORTS_DISCRIMINATOR);
}
function getUnwrapLamportsInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU8Encoder()],
      ["amount", kit.getOptionEncoder(kit.getU64Encoder())]
    ]),
    (value) => ({ ...value, discriminator: UNWRAP_LAMPORTS_DISCRIMINATOR, amount: value.amount ?? kit.none() })
  );
}
function getUnwrapLamportsInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU8Decoder()],
    ["amount", kit.getOptionDecoder(kit.getU64Decoder())]
  ]);
}
function getUnwrapLamportsInstructionDataCodec() {
  return kit.combineCodec(getUnwrapLamportsInstructionDataEncoder(), getUnwrapLamportsInstructionDataDecoder());
}
function getUnwrapLamportsInstruction(input, config) {
  const programAddress = config?.programAddress ?? TOKEN_PROGRAM_ADDRESS;
  const originalAccounts = {
    source: { value: input.source ?? null, isWritable: true },
    destination: { value: input.destination ?? null, isWritable: true },
  ...
  return Object.freeze({
    ...
    data: getUnwrapLamportsInstructionDataEncoder().encode(args),
    programAddress
  });
}
function parseUnwrapLamportsInstruction(instruction) {
  if (instruction.accounts.length < 3) {
    throw new kit.SolanaError(kit.SOLANA_ERROR__PROGRAM_CLIENTS__INSUFFICIENT_ACCOUNT_METAS, {
      actualAccountMetas: instruction.accounts.length,
      expectedAccountMetas: 3
...
// src/generated/programs/associatedToken.ts
...
function parseAssociatedTokenInstruction(instruction) {
  const instructionType = identifyAssociatedTokenInstruction(instruction);
  switch (instructionType) {
    case 0 /* CreateAssociatedToken */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 0 /* CreateAssociatedToken */,
        ...parseCreateAssociatedTokenInstruction(instruction)
      };
    }
    case 1 /* CreateAssociatedTokenIdempotent */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 1 /* CreateAssociatedTokenIdempotent */,
        ...parseCreateAssociatedTokenIdempotentInstruction(instruction)
      };
    }
    case 2 /* RecoverNestedAssociatedToken */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 2 /* RecoverNestedAssociatedToken */,
...
function associatedTokenProgram() {
  return (client) => {
    return kit.extendClient(client, {
      associatedToken: {
        instructions: {
          createAssociatedToken: (input) => programClientCore.addSelfPlanAndSendFunctions(
            client,
            getCreateAssociatedTokenInstructionAsync({ ...input, payer: input.payer ?? client.payer })
          ),
          createAssociatedTokenIdempotent: (input) => programClientCore.addSelfPlanAndSendFunctions(
            client,
          ...
          recoverNestedAssociatedToken: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getRecoverNestedAssociatedTokenInstructionAsync(input))
        },
...
function identifyTokenAccount(account) {
  ...
  throw new kit.SolanaError(kit.SOLANA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_ACCOUNT, {
    accountData: data,
    programName: "token"
  });
}
var TokenInstruction = /* @__PURE__ */ ((TokenInstruction2) => {
  ...
  TokenInstruction2[TokenInstruction2["WithdrawExcessLamports"] = 25] = "WithdrawExcessLamports";
  TokenInstruction2[TokenInstruction2["UnwrapLamports"] = 26] = "UnwrapLamports";
  TokenInstruction2[TokenInstruction2["Batch"] = 27] = "Batch";
...
function identifyTokenInstruction(instruction) {
  ...
  if (kit.containsBytes(data, kit.getU8Encoder().encode(38), 0)) {
    return 25 /* WithdrawExcessLamports */;
  }
  if (kit.containsBytes(data, kit.getU8Encoder().encode(45), 0)) {
    return 26 /* UnwrapLamports */;
  }
  if (kit.containsBytes(data, kit.getU8Encoder().encode(255), 0)) {
    return 27 /* Batch */;
  }
  throw new kit.SolanaError(kit.SOLANA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_INSTRUCTION, {
    instructionData: data,
...
function parseTokenInstruction(instruction) {
  const instructionType = identifyTokenInstruction(instruction);
  switch (instructionType) {
    case 0 /* InitializeMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 0 /* InitializeMint */, ...parseInitializeMintInstruction(instruction) };
    }
    case 1 /* InitializeAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 1 /* InitializeAccount */,
    ...
    case 2 /* InitializeMultisig */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 2 /* InitializeMultisig */,
        ...parseInitializeMultisigInstruction(instruction)
      };
    }
    case 3 /* Transfer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 3 /* Transfer */, ...parseTransferInstruction(instruction) };
    }
    case 4 /* Approve */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 4 /* Approve */, ...parseApproveInstruction(instruction) };
    }
    case 5 /* Revoke */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 5 /* Revoke */, ...parseRevokeInstruction(instruction) };
    }
    case 6 /* SetAuthority */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 6 /* SetAuthority */, ...parseSetAuthorityInstruction(instruction) };
    }
    case 7 /* MintTo */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 7 /* MintTo */, ...parseMintToInstruction(instruction) };
    }
    case 8 /* Burn */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 8 /* Burn */, ...parseBurnInstruction(instruction) };
    }
    case 9 /* CloseAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 9 /* CloseAccount */, ...parseCloseAccountInstruction(instruction) };
    }
    case 10 /* FreezeAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 10 /* FreezeAccount */, ...parseFreezeAccountInstruction(instruction) };
    }
    case 11 /* ThawAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 11 /* ThawAccount */, ...parseThawAccountInstruction(instruction) };
    }
    case 12 /* TransferChecked */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 12 /* TransferChecked */,
        ...parseTransferCheckedInstruction(instruction)
      };
    }
    case 13 /* ApproveChecked */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 13 /* ApproveChecked */, ...parseApproveCheckedInstruction(instruction) };
    }
    case 14 /* MintToChecked */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 14 /* MintToChecked */, ...parseMintToCheckedInstruction(instruction) };
    }
    case 15 /* BurnChecked */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 15 /* BurnChecked */, ...parseBurnCheckedInstruction(instruction) };
    }
    case 16 /* InitializeAccount2 */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 16 /* InitializeAccount2 */,
        ...parseInitializeAccount2Instruction(instruction)
      };
    }
    case 17 /* SyncNative */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 17 /* SyncNative */, ...parseSyncNativeInstruction(instruction) };
    }
    case 18 /* InitializeAccount3 */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 18 /* InitializeAccount3 */,
    ...
    case 19 /* InitializeMultisig2 */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 19 /* InitializeMultisig2 */,
    ...
    case 20 /* InitializeMint2 */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 20 /* InitializeMint2 */,
    ...
    case 21 /* GetAccountDataSize */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 21 /* GetAccountDataSize */,
    ...
    case 22 /* InitializeImmutableOwner */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 22 /* InitializeImmutableOwner */,
    ...
    case 23 /* AmountToUiAmount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 23 /* AmountToUiAmount */,
    ...
    case 24 /* UiAmountToAmount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 24 /* UiAmountToAmount */,
        ...parseUiAmountToAmountInstruction(instruction)
      };
    }
    case 25 /* WithdrawExcessLamports */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 25 /* WithdrawExcessLamports */,
        ...parseWithdrawExcessLamportsInstruction(instruction)
      };
    }
    case 26 /* UnwrapLamports */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 26 /* UnwrapLamports */, ...parseUnwrapLamportsInstruction(instruction) };
    }
    case 27 /* Batch */: {
      return { instructionType: 27 /* Batch */, ...parseBatchInstruction(instruction) };
    }
    default:
      throw new kit.SolanaError(kit.SOLANA_ERROR__PROGRAM_CLIENTS__UNRECOGNIZED_INSTRUCTION_TYPE, {
        instructionType,
...
function tokenProgram() {
  return (client) => {
    return kit.extendClient(client, {
      token: {
        accounts: {
          mint: programClientCore.addSelfFetchFunctions(client, getMintCodec()),
          token: programClientCore.addSelfFetchFunctions(client, getTokenCodec()),
          multisig: programClientCore.addSelfFetchFunctions(client, getMultisigCodec())
        },
        instructions: {
          initializeMint: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeMintInstruction(input)),
          initializeAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeAccountInstruction(input)),
          initializeMultisig: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeMultisigInstruction(input)),
          transfer: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getTransferInstruction(input)),
          approve: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getApproveInstruction(input)),
          revoke: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getRevokeInstruction(input)),
          setAuthority: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getSetAuthorityInstruction(input)),
          mintTo: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getMintToInstruction(input)),
          burn: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getBurnInstruction(input)),
          closeAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getCloseAccountInstruction(input)),
          freezeAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getFreezeAccountInstruction(input)),
          thawAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getThawAccountInstruction(input)),
          transferChecked: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getTransferCheckedInstruction(input)),
          approveChecked: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getApproveCheckedInstruction(input)),
          mintToChecked: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getMintToCheckedInstruction(input)),
          burnChecked: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getBurnCheckedInstruction(input)),
          initializeAccount2: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeAccount2Instruction(input)),
          syncNative: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getSyncNativeInstruction(input)),
          initializeAccount3: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeAccount3Instruction(input)),
          initializeMultisig2: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeMultisig2Instruction(input)),
          initializeMint2: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeMint2Instruction(input)),
          getAccountDataSize: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getGetAccountDataSizeInstruction(input)),
          initializeImmutableOwner: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeImmutableOwnerInstruction(input)),
          amountToUiAmount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getAmountToUiAmountInstruction(input)),
          uiAmountToAmount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getUiAmountToAmountInstruction(input)),
          withdrawExcessLamports: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getWithdrawExcessLamportsInstruction(input)),
          unwrapLamports: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getUnwrapLamportsInstruction(input)),
          batch: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getBatchInstruction(input))
        },
...
function isAssociatedTokenError(error, transactionMessage, code) {
  return kit.isProgramError(error, transactionMessage, ASSOCIATED_TOKEN_PROGRAM_ADDRESS, code);
}
...
function isTokenError(error, transactionMessage, code) {
  return kit.isProgramError(error, transactionMessage, TOKEN_PROGRAM_ADDRESS, code);
}

// src/batch.ts
function getBatchInstruction2(instructions, config) {
  const programAddress = config?.programAddress ?? TOKEN_PROGRAM_ADDRESS;
  ...
  return Object.freeze({
    ...getBatchInstruction({ data }, config),
    accounts
  });
}
function parseBatchInstruction2(instruction) {
  const rawBatchInstruction = parseBatchInstruction(instruction);
  let accountOffset = 0;
  const instructions = rawBatchInstruction.data.data.map(({ numberOfAccounts, instructionData }) => {
    const innerInstruction = parseTokenInstruction({
      programAddress: instruction.programAddress,
...
async function getCreateMintInstructionPlan(client, input, config) {
...
async function getMintToATAInstructionPlanAsync(input, config) {
  const tokenProgram3 = config?.tokenProgram ?? TOKEN_PROGRAM_ADDRESS;
  let ata = input.ata;
  if (!ata) {
...
// src/plugin.ts
function tokenProgram2() {
  return (client) => {
    return kit.pipe(
      client,
      tokenProgram(),
      (c) => kit.extendClient(c, {
        token: {
          ...c.token,
          instructions: {
            ...c.token.instructions,
            batch: (input, config) => programClientCore.addSelfPlanAndSendFunctions(client, getBatchInstruction2(input, config)),
            createMint: (input, config) => programClientCore.addSelfPlanAndSendFunctions(
              client,
            ...
            mintToATA: (input, config) => programClientCore.addSelfPlanAndSendFunctions(
              client,
            ...
            transferToATA: (input, config) => programClientCore.addSelfPlanAndSendFunctions(
              client,
...
exports.BATCH_DISCRIMINATOR = BATCH_DISCRIMINATOR;
...
exports.UNWRAP_LAMPORTS_DISCRIMINATOR = UNWRAP_LAMPORTS_DISCRIMINATOR;
...
exports.getBatchInstruction = getBatchInstruction2;
exports.getBatchInstructionDataCodec = getBatchInstructionDataCodec;
exports.getBatchInstructionDataDecoder = getBatchInstructionDataDecoder;
exports.getBatchInstructionDataEncoder = getBatchInstructionDataEncoder;
...
exports.getUnwrapLamportsDiscriminatorBytes = getUnwrapLamportsDiscriminatorBytes;
exports.getUnwrapLamportsInstruction = getUnwrapLamportsInstruction;
exports.getUnwrapLamportsInstructionDataCodec = getUnwrapLamportsInstructionDataCodec;
exports.getUnwrapLamportsInstructionDataDecoder = getUnwrapLamportsInstructionDataDecoder;
exports.getUnwrapLamportsInstructionDataEncoder = getUnwrapLamportsInstructionDataEncoder;
...
exports.parseAssociatedTokenInstruction = parseAssociatedTokenInstruction;
exports.parseBatchInstruction = parseBatchInstruction2;
...
exports.parseTokenInstruction = parseTokenInstruction;
...
exports.parseUnwrapLamportsInstruction = parseUnwrapLamportsInstruction;
exports.parseWithdrawExcessLamportsInstruction = parseWithdrawExcessLamportsInstruction;
exports.tokenProgram = tokenProgram2;
