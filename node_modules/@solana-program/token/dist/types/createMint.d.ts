import { Address, ClientWithGetMinimumBalance, InstructionPlan, OptionOrNullable, TransactionSigner } from '@solana/kit';
...
export declare function getCreateMintInstructionPlan(client: ClientWithGetMinimumBalance, input: CreateMintInstructionPlanInput, config?: CreateMintInstructionPlanConfig): Promise<InstructionPlan>;
