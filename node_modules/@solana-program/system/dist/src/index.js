...
function decodeNonce(encodedAccount) {
  return kit.decodeAccount(encodedAccount, getNonceDecoder());
}
...
function getAdvanceNonceAccountInstructionDataEncoder() {
  return kit.transformEncoder(kit.getStructEncoder([["discriminator", kit.getU32Encoder()]]), (value) => ({
    ...value,
...
function getAdvanceNonceAccountInstructionDataCodec() {
  return kit.combineCodec(getAdvanceNonceAccountInstructionDataEncoder(), getAdvanceNonceAccountInstructionDataDecoder());
}
...
function getAllocateInstructionDataCodec() {
  return kit.combineCodec(getAllocateInstructionDataEncoder(), getAllocateInstructionDataDecoder());
}
...
function getAllocateWithSeedInstructionDataCodec() {
  return kit.combineCodec(getAllocateWithSeedInstructionDataEncoder(), getAllocateWithSeedInstructionDataDecoder());
}
...
function getAssignInstructionDataCodec() {
  return kit.combineCodec(getAssignInstructionDataEncoder(), getAssignInstructionDataDecoder());
}
...
function getAssignWithSeedInstructionDataCodec() {
  return kit.combineCodec(getAssignWithSeedInstructionDataEncoder(), getAssignWithSeedInstructionDataDecoder());
}
...
function getCreateAccountInstructionDataCodec() {
  return kit.combineCodec(getCreateAccountInstructionDataEncoder(), getCreateAccountInstructionDataDecoder());
}
function getCreateAccountInstruction(input, config) {
  ...
  const accounts = originalAccounts;
  const args = { ...input };
  const byteDelta = [Number(args.space) + kit.BASE_ACCOUNT_SIZE].reduce((a, b) => a + b, 0);
  const getAccountMeta = programClientCore.getAccountMetaFactory(programAddress, "omitted");
  return Object.freeze({
...
var CREATE_ACCOUNT_ALLOW_PREFUND_DISCRIMINATOR = 13;
function getCreateAccountAllowPrefundDiscriminatorBytes() {
  return kit.getU32Encoder().encode(CREATE_ACCOUNT_ALLOW_PREFUND_DISCRIMINATOR);
}
function getCreateAccountAllowPrefundInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU32Encoder()],
      ["lamports", kit.getU64Encoder()],
...
function getCreateAccountAllowPrefundInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU32Decoder()],
    ["lamports", kit.getU64Decoder()],
    ["space", kit.getU64Decoder()],
...
function getCreateAccountAllowPrefundInstructionDataCodec() {
  return kit.combineCodec(
    getCreateAccountAllowPrefundInstructionDataEncoder(),
    getCreateAccountAllowPrefundInstructionDataDecoder()
  );
}
function getCreateAccountAllowPrefundInstruction(input, config) {
  const programAddress = config?.programAddress ?? SYSTEM_PROGRAM_ADDRESS;
  const originalAccounts = {
    newAccount: { value: input.newAccount ?? null, isWritable: true },
    payer: { value: input.payer ?? null, isWritable: true }
...
function parseCreateAccountAllowPrefundInstruction(instruction) {
  if (instruction.accounts.length < 1) {
    throw new kit.SolanaError(kit.SOLANA_ERROR__PROGRAM_CLIENTS__INSUFFICIENT_ACCOUNT_METAS, {
      actualAccountMetas: instruction.accounts.length,
      expectedAccountMetas: 1
...
function getTransferSolInstructionDataCodec() {
  return kit.combineCodec(getTransferSolInstructionDataEncoder(), getTransferSolInstructionDataDecoder());
}
...
function getTransferSolWithSeedInstructionDataCodec() {
  return kit.combineCodec(getTransferSolWithSeedInstructionDataEncoder(), getTransferSolWithSeedInstructionDataDecoder());
}
...
function getUpgradeNonceAccountInstructionDataCodec() {
  return kit.combineCodec(getUpgradeNonceAccountInstructionDataEncoder(), getUpgradeNonceAccountInstructionDataDecoder());
}
...
// src/generated/programs/system.ts
...
var SystemInstruction = /* @__PURE__ */ ((SystemInstruction2) => {
  ...
  SystemInstruction2[SystemInstruction2["CreateAccountAllowPrefund"] = 13] = "CreateAccountAllowPrefund";
...
function identifySystemInstruction(instruction) {
  ...
  if (kit.containsBytes(data, kit.getU32Encoder().encode(13), 0)) {
    return 13 /* CreateAccountAllowPrefund */;
  }
...
function parseSystemInstruction(instruction) {
  ...
  switch (instructionType) {
    case 0 /* CreateAccount */: {
      ...
      return { instructionType: 0 /* CreateAccount */, ...parseCreateAccountInstruction(instruction) };
    }
    case 1 /* Assign */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 1 /* Assign */, ...parseAssignInstruction(instruction) };
    }
    case 2 /* TransferSol */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 2 /* TransferSol */, ...parseTransferSolInstruction(instruction) };
    }
    case 3 /* CreateAccountWithSeed */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 3 /* CreateAccountWithSeed */,
    ...
    case 4 /* AdvanceNonceAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 4 /* AdvanceNonceAccount */,
    ...
    case 5 /* WithdrawNonceAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 5 /* WithdrawNonceAccount */,
    ...
    case 6 /* InitializeNonceAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 6 /* InitializeNonceAccount */,
    ...
    case 7 /* AuthorizeNonceAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 7 /* AuthorizeNonceAccount */,
        ...parseAuthorizeNonceAccountInstruction(instruction)
      };
    }
    case 8 /* Allocate */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 8 /* Allocate */, ...parseAllocateInstruction(instruction) };
    }
    case 9 /* AllocateWithSeed */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 9 /* AllocateWithSeed */,
    ...
    case 10 /* AssignWithSeed */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 10 /* AssignWithSeed */,
        ...parseAssignWithSeedInstruction(instruction)
      };
    }
    case 11 /* TransferSolWithSeed */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 11 /* TransferSolWithSeed */,
    ...
    case 12 /* UpgradeNonceAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 12 /* UpgradeNonceAccount */,
        ...parseUpgradeNonceAccountInstruction(instruction)
      };
    }
    case 13 /* CreateAccountAllowPrefund */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 13 /* CreateAccountAllowPrefund */,
...
function systemProgram() {
  return (client) => {
    return kit.extendClient(client, {
      system: {
        accounts: { nonce: programClientCore.addSelfFetchFunctions(client, getNonceCodec()) },
        instructions: {
          createAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(
            client,
            getCreateAccountInstruction({ ...input, payer: input.payer ?? client.payer })
          ),
          assign: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getAssignInstruction(input)),
          transferSol: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getTransferSolInstruction(input)),
          createAccountWithSeed: (input) => programClientCore.addSelfPlanAndSendFunctions(
            client,
            getCreateAccountWithSeedInstruction({ ...input, payer: input.payer ?? client.payer })
          ),
          advanceNonceAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getAdvanceNonceAccountInstruction(input)),
          withdrawNonceAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getWithdrawNonceAccountInstruction(input)),
          initializeNonceAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getInitializeNonceAccountInstruction(input)),
          authorizeNonceAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getAuthorizeNonceAccountInstruction(input)),
          allocate: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getAllocateInstruction(input)),
          allocateWithSeed: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getAllocateWithSeedInstruction(input)),
          assignWithSeed: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getAssignWithSeedInstruction(input)),
          transferSolWithSeed: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getTransferSolWithSeedInstruction(input)),
          upgradeNonceAccount: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getUpgradeNonceAccountInstruction(input)),
          createAccountAllowPrefund: (input) => programClientCore.addSelfPlanAndSendFunctions(client, getCreateAccountAllowPrefundInstruction(input))
        },
...
function isSystemError(error, transactionMessage, code) {
  return kit.isProgramError(error, transactionMessage, SYSTEM_PROGRAM_ADDRESS, code);
}
...
exports.CREATE_ACCOUNT_ALLOW_PREFUND_DISCRIMINATOR = CREATE_ACCOUNT_ALLOW_PREFUND_DISCRIMINATOR;
...
exports.getCreateAccountAllowPrefundDiscriminatorBytes = getCreateAccountAllowPrefundDiscriminatorBytes;
exports.getCreateAccountAllowPrefundInstruction = getCreateAccountAllowPrefundInstruction;
exports.getCreateAccountAllowPrefundInstructionDataCodec = getCreateAccountAllowPrefundInstructionDataCodec;
exports.getCreateAccountAllowPrefundInstructionDataDecoder = getCreateAccountAllowPrefundInstructionDataDecoder;
exports.getCreateAccountAllowPrefundInstructionDataEncoder = getCreateAccountAllowPrefundInstructionDataEncoder;
...
exports.parseCreateAccountAllowPrefundInstruction = parseCreateAccountAllowPrefundInstruction;
...
exports.parseSystemInstruction = parseSystemInstruction;
